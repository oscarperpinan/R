...
\begin{frame}[fragile,label=sec-1-4]{Inspeccionamos el resultado}
 \lstset{language=R,label= ,caption= ,numbers=none}
\begin{lstlisting}
head(aranjuez)
\end{lstlisting}
...
\begin{frame}[fragile,label=sec-1-5]{Inspeccionamos el resultado}
 \lstset{language=R,label= ,caption= ,numbers=none}
\begin{lstlisting}
summary(aranjuez)
\end{lstlisting}
...
\begin{frame}[fragile,label=sec-1-6]{Valores ausentes}
 \begin{itemize}
...
\begin{frame}[fragile,label=sec-1-7]{Valores ausentes}
