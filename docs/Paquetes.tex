...
\begin{frame}[fragile,label={sec:orgheadline21}]{Repositorios: CRAN}
...
\begin{frame}[fragile,label={sec:orgheadline23}]{Repositorios: GitHub}
 \begin{itemize}
\item GitHub es actualmente el repositorio de código más importante por número de usuarios y proyectos alojados.
\begin{itemize}
\item Documentación: \href{https://guides.github.com/}{Guías sobre GitHub} y \href{https://training.github.com/kit/courses/github-for-everyone.html}{GitHub for everyone}.
