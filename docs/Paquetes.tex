...
\begin{frame}[fragile,label={sec:orgb53d32c}]{¿Por qué crear y publicar un paquete para \texttt{R}?}
 \begin{itemize}
...
\begin{frame}[label={sec:orgf24c083}]{Algunos consejos genéricos}
...
\begin{frame}[label={sec:org24ae684}]{}
...
\label{sec:org473f84d}

\begin{frame}[fragile,label={sec:orgb992856}]{Estructura}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:org78c12db}]{NAMESPACE}
...
\begin{frame}[fragile,label={sec:org816552a}]{NAMESPACE}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgeea74ef}]{Documentación}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org76fd15f}]{}
 \begin{verbatim}
  \name{load}
  \alias{load}
...
\begin{frame}[fragile,label={sec:org25959bf}]{Comprobar}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:org2e24a6b}]{Construir}
...
\begin{frame}[fragile,label={sec:org35dab97}]{Comprobar y construir en sistemas Windows}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orge8f12af}]{Repositorios: CRAN}
