...
\begin{frame}[label={sec:org5b2bd4a},fragile]{Inspeccionamos el resultado}
 \lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
head(aranjuez)
\end{lstlisting}
...
\begin{frame}[label={sec:org03ac43a},fragile]{Inspeccionamos el resultado}
 \lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
summary(aranjuez)
\end{lstlisting}
...
\begin{frame}[label={sec:org842277d},fragile]{Valores ausentes}
 \begin{itemize}
...
\begin{frame}[label={sec:org5537d10},fragile]{Valores ausentes}
...
\section{Indexado}
\label{sec:org0ebf9e3}

\begin{frame}[label={sec:org79b2c65},fragile]{Indexado con \texttt{[]}}
 \begin{itemize}
\item Filas
\end{itemize}
\lstset{language=r,label= ,caption= ,captionpos=b,numbers=none}
