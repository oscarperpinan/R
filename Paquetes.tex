...
\begin{frame}[label={sec:orgheadline1}]{Definiciones previas (\href{http://cran.r-project.org/doc/contrib/Leisch-CreatingPackages.pdf}{Creating R Packages: a tutorial})}
\begin{itemize}
...
\begin{frame}[label={sec:orgheadline2}]{Definiciones previas (\href{http://cran.r-project.org/doc/contrib/Leisch-CreatingPackages.pdf}{Creating R Packages: a tutorial})}
\begin{itemize}
...
\begin{frame}[label={sec:orgheadline3}]{Definiciones previas (\href{http://cran.r-project.org/doc/contrib/Leisch-CreatingPackages.pdf}{Creating R Packages: a tutorial})}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:orgheadline4}]{¿Por qué crear y publicar un paquete para \texttt{R}?}
 \begin{itemize}
...
\begin{frame}[label={sec:orgheadline5}]{Algunos consejos genéricos}
...
\begin{frame}[label={sec:orgheadline6}]{}
...
\item \href{http://kbroman.org/pkg_primer/}{R package primer}
...
\begin{frame}[fragile,label={sec:orgheadline8}]{Estructura}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgheadline9}]{DESCRIPTION}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:orgheadline10}]{NAMESPACE}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:orgheadline11}]{NAMESPACE}
 \begin{itemize}
\item El \texttt{NAMESPACE} controla la estrategia de búsqueda de variables
...
\begin{frame}[fragile,label={sec:orgheadline12}]{NAMESPACE}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgheadline13}]{NAMESPACE}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgheadline14}]{Documentación}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgheadline15}]{}
 \begin{verbatim}
  \name{load}
  \alias{load}
...
\begin{frame}[fragile,label={sec:orgheadline17}]{Itinerario}
 \begin{itemize}
\item Comprobar
\end{itemize}
\begin{verbatim}
...
\begin{frame}[fragile,label={sec:orgheadline18}]{Comprobar}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[fragile,label={sec:orgheadline19}]{Construir}
...
\begin{frame}[fragile,label={sec:orgheadline20}]{Comprobar y construir en sistemas Windows}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgheadline21}]{Repositorios}
 \begin{itemize}
...
\begin{frame}[label={sec:orgheadline22}]{Repositorios}
\begin{itemize}
