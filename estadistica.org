...
#+begin_src R :results output graphics :file figs/rnorm.pdf
...
** Distribución Normal
#+begin_src R :results output graphics :file figs/dnorm.pdf
x <- seq( -5, 5, by =.01)
...
#+begin_src R :results output graphics :file figs/runif.pdf
...
#+begin_src R :results output graphics :file figs/rweibull.pdf
hist(rweibull(1e6, shape = 3, scale = 2))
#+end_src

#+ATTR_LATEX: :height 0.6\textheight
#+RESULTS:
[[file:figs/rweibull.pdf]]
...
** Fertilidad y educación
#+begin_src R :results output graphics :file figs/lmFertEdu.pdf
plot(lmFertEdu, which = 1)
#+end_src

#+ATTR_LATEX: :height 0.85\textheight
#+RESULTS:
[[file:figs/lmFertEdu.pdf]]
